...
1. Corre primeiro scrapers HTTP simples (rápido, sem browser) — atualmente nenhum,
   já que o diagnóstico real mostrou que todas as fontes precisam de browser.
2. Um único browser Playwright, reutilizado entre todas as fontes.
3. Grava o resultado final num único ficheiro JSON, versionado no git.
"""
import json
import logging
import os
