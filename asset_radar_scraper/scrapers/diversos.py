...
class AutoUncleScraper(BaseScraper):
    ...
    category = "carro"
    needs_browser = True  # ficheiro debug veio truncado/curto com HTTP simples — precisa de browser
...
class JoliClosetScraper(BaseScraper):
    ...
    category = "moda"
    needs_browser = True  # ficheiro debug veio vazio com HTTP simples — precisa de browser
